...
--? EXISTS: se usa en consultas para verificar si una subconsulta devuelve algún resultado. Si la subconsulta devuelve 
--? al menos una fila, la condición se evalúa como TRUE.