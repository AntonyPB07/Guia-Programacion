...
INSERT INTO Inventario (id_producto, cantidad_disponible) VALUES (3, 8);
INSERT INTO Inventario (id_producto, cantidad_disponible) VALUES (4, 50);
INSERT INTO Inventario (id_producto, cantidad_disponible) VALUES (5, 16);
...
INSERT INTO Pedido (id_cliente, id_direccion) VALUES (1, 5);

select * from detallepedido;
insert into detallepedido (id_pedido, id_producto, cantidad, precio_unitario) values (2, 1, 8, 9500);
insert into detallepedido (id_pedido, id_producto, cantidad, precio_unitario) values (3, 2, 16, 1999);
insert into detallepedido (id_pedido, id_producto, cantidad, precio_unitario) values (4, 3, 3, 350);
insert into detallepedido (id_pedido, id_producto, cantidad, precio_unitario) values (5, 4, 17, 27999);
insert into detallepedido (id_pedido, id_producto, cantidad, precio_unitario) values (6, 5, 12, 2500);
insert into detallepedido (id_pedido, id_producto, cantidad, precio_unitario) values (6, 4, 2, 27999);