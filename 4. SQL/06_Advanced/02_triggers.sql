...
--? TRIGGERS: es un disparador que permite definir acciones automáticas que se activan cuando ocurren ciertos eventos en una tabla. Estos eventos pueden ser INSERT, UPDATE o DELETE.
...
END; /* 
--? EJEMPLO DE LA ESTRUCTURA DE UN TRIGGER