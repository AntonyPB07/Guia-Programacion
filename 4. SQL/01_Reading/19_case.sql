...
--? CASE: es una estructura de control condicional que te permite realizar evaluaciones condicionales en tus consultas y devolver diferentes resultados según la evaluación de esas condiciones.